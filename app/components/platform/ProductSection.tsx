      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-light tracking-wide text-white/80">Product Overview</span>
          </motion.div>
          
          <div className="relative space-y-6">
            <h2 className="bg-gradient-to-r from-white via-white/90 to-white/80 bg-clip-text text-6xl font-light tracking-tight text-transparent">
              {productName}
            </h2>
            <motion.div 
            ...
            />
            <p className="text-xl font-light leading-relaxed tracking-wide text-white/70">
              {productDescription}
            </p>
          </div>
        </motion.div>
        ...
        <div className="relative mt-32 grid gap-24 lg:grid-cols-2">
          ...
          <motion.div
            ...
            className="group relative aspect-[4/3] overflow-hidden rounded-3xl bg-gradient-to-br from-white/[0.08] to-white/[0.03] p-[1px]"
          >
            <div className="absolute inset-0">
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="relative space-y-4">
                  ...
                  <p className="text-lg font-light leading-relaxed tracking-wide text-white/70">
                    {feature.description}
                  </p>
