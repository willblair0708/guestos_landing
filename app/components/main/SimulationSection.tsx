  ...
  return (
    ...
    >
      <motion.div className='w-full' style={{ y: ySpring, opacity }}>
        ...
        >
          <motion.div className='w-full space-y-6 sm:w-1/2'>
            <motion.h2
              ...
              className='text-[24px] font-book leading-[28.8px] tracking-[-0.01em] text-[#18181B]'
            >
              {isMobile ? (
          ...
          >
            <motion.p
              variants={itemVariants}
              className='text-[13px] font-book tracking-tight text-black'
            >
        ...
        <div className={`mx-auto ${isMobile ? '-mt-[400px]' : ''}`}>
...
function ProductPreview() {
  ...
  return (
    <div className='relative mx-auto mt-16 h-[400px] w-full max-w-screen-2xl rounded-t-[40px] bg-black p-2 pb-0 sm:mt-32 sm:h-[600px] sm:p-4 sm:pb-0'>
